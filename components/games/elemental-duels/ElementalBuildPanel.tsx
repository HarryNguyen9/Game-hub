    ...
    <div className="rounded-3xl bg-white p-4 shadow-sm">
      ...
      {selectedTower ? (
        <div className="grid gap-2">
          <p className="text-sm font-bold text-slate-500">Selected tower level {selectedTower.level}</p>
        ...
        <div className="grid gap-2">
          {!selectedTile && <p className="text-sm font-bold text-slate-500">Tap a build tile on your field.</p>}
